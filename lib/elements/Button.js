...
const StyledButton = styled.button.attrs(props => {
  ...
  let className = props.className ? props.className : type;
  return {
    type: type,
  ...
  padding-top: 12px;
  padding-bottom: 12px;
  padding-right: ${props => (props.type === "transparent" ? "0px" : "20px")};
  padding-left: ${props => (props.type === "transparent" ? "0px" : "20px")};
  outline: none;
  border: none;
  ${transition}
  &:hover {
