...
const ContainerWrapper = styled.section`
  ...
  ${props => props.tombstone && `margin-top: -350px`};
...
${props =>
  ...
  ${props => props.customHeightMd && `height: ${props.customHeightMd}px`};
  ${props => props.tombstone && `margin-top: -450px`};
`};
  ...
  ${props =>
    ...
    ${props => props.customHeightSm && `height: ${props.customHeightSm}px`};
    ${props => props.tombstone && `margin-top: -450px`};
  `};
  ...
  ${props =>
    ...
    ${props => props.customHeightXs && `height: ${props.customHeightXs}px`};
    ${props => props.tombstone && `margin-top: -450px`};
  `};
