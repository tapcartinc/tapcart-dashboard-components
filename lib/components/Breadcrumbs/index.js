...
const Breadcrumbs = ({ crumbs, hideOnTabletAndMobile }) => {
  return (
    <BreadcrumbsStyle hideOnTabletAndMobile={hideOnTabletAndMobile}>
...
const BreadcrumbsStyle = styled.ul`
  ...
  ${media.md`
  ${props => props.hideOnTabletAndMobile && `display: none`}
  `};
...
Breadcrumbs.propTypes = {
  crumbs: PropTypes.arrayOf(
    PropTypes.shape({
      ...
      hideOnTabletAndMobile: PropTypes.bool,
      /**
