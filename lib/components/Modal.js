...
function ModalType(props) {
  switch (props.type) {
    case "slider-modal":
      return (
        <SliderModal key="slider-modal" {...props}>
          {props.children}
        </SliderModal>
      );
    case "custom":
      return (
        <MinimalModalStyle key="custom" {...props}>
          {props.children}
        </MinimalModalStyle>
      );
    case "full":
      return (
        <FullscreenModal key="full" {...props}>
          {props.children}
        </FullscreenModal>
      );
    case "modal-with-graphic":
      return (
        <ModalWithGraphic key="modal-with-graphic" {...props}>
    ...
    case "alert":
      return (
        <MinimalModalStyle key="alert" {...props}>
          <ModalHeader>
            <ModalHeaderLeft>
              <Icon circleIcon type={props.icon} />
