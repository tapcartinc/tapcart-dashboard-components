...
import { Header, Description } from "../elements/TypographyOld";
          ...
          <div style={{ padding: 25 }}>
            <ModalHeader>
              <ModalHeaderLeft>
                ...
                <Header style={{ marginLeft: 10 }}>{props.header}</Header>
              </ModalHeaderLeft>
            </ModalHeader>
            ...
            <ButtonsStyle>
              {props.buttons &&
                props.buttons.map((button, idx) => {
                  return (
                    <div
                      key={`${button.type}-${button.button}-${props.header}`}
      ...
      return (
        <MinimalModalStyle {...props}>
          <ModalHeader>
            <ModalHeaderLeft>
              <Icon circleIcon type={props.icon} />
              <Header style={{ marginLeft: 15 }}>{props.header}</Header>
            </ModalHeaderLeft>
