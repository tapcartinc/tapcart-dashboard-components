...
const StyledBody = styled(Body)`
  ...
  ${media.sm`
    ${props =>
      props.pagNav &&
      `display: flex; align-items: center; width: 20px; margin: 0px`}
    .mobile-hide {
      display: none;
    }
  `}
    ...
    elements.push(
      <DisabledPage key={"prev"} {...props} pagNav>
        <StyledBody color={colors.grayText} pagNav>
          ...
          <p className="mobile-hide"> PREV</p>
        </StyledBody>
      </DisabledPage>
    );
  } else {
  ...
  if (currentPage > 4) {
    elements.push(
      <>
        ...
        <StyledBody color={colors.grayText} color={colors.grayText}>
          ...
        </StyledBody>
      </>
    );
  ...
  if (currentPage === pagRange) {
    elements.push(
      <DisabledPage {...props} key={"next"} pagNav>
        <StyledBody color={colors.grayText} pagNav>
          <p className="mobile-hide"> NEXT</p>
