...
const StyledPanelWrapper = styled.div.attrs(props => ({
  ...
  background: white;
  ${props =>
    props.spacing ? `margin-bottom: ${props.spacing}px` : `margin-bottom: 0px`};
  ${props =>
  ...
  ${props => !props.includeBorder && `border: none`};
...
const StyledPanelInnerChildren = styled.div.attrs(props => ({
