...
})(["font-family:CircularStd-Bold,-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif;font-weight:bold;font-style:normal;font-size:40px;line-height:50px;margin-bottom:15px;margin-top:20px;z-index:3;-webkit-font-smoothing:antialiased;color:", ";", " ", ""], function (props) {
  if (props.color) {
